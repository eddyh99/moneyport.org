        ...
        <nav id="navbar" class="navbar">
            <ul class="px-5">
                ...
                <li><a class="f-bevietnam nav-link mx-0 my-2 mx-lg-2 my-lg-auto text-center btn-login"
                        href="<?= base_url(); ?>auth/login"><span>Log
                            in</span></a>
                </li>
            </ul>
...
<!-- ======= Hero Section ======= -->
<section id="top" class="hero bg-picture-1 pb-0">
    <div class="container">
        <div class="row">
...
<main id="main">
    ...
    <section id="" class="about bg-picture-2">
        <div class="container p-r">
            <div class="row gx-0">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center mb-5 ps-lg-5">
                    ...
                    <div class="row d-flex justify-content-end my-3">
                        <div class="col-lg-10 p-r">
                            <div class="content-freedy">
                                <h2 class="f-lexend">Account for free </h2>
                                <ul class="p-0 f-lexend">
                                    <li>MoneyPort account opening is free</li>
                                    <li>No monthly or annual fees are requested</li>
                                    <li>Can be Integrated to your business without any extra cost</li>
                    ...
                    <div class="reward p-3 p-md-5">
                        <div class="col-12 p-3 text-center">
                            ...
                            <span class="shareit d-block mb-4">
                                ...
                                <br>
                                Share it and get reward forever
                            </span>
                            <a href="<?= base_url() ?>link/lern_reward" class="btn-content-freedy px-3 py-2">Learn
                                more</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- ======= Section ======= -->
    <section id="" class="about bg-picture-4">
        <div class="container p-r">
            <div class="row gx-0 d-flex justify-content-center">
                <div class="col-lg-6 mb-5 ps-lg-5">
                    <div class="content-freedy">
                        <h2 class="f-lexend">The great anonymous debit card that fully protect your privacy</h2>
                        <div class="my-3">
                            <ul class="p-0 f-lexend">
                ...
                <div class="col-12">
                    <div class="row d-flex justify-content-center">
                        <div class="col-12 features-freedy">
                            <div
                                class="features-freedy text-center d-flex align-items-center justify-content-around flex-wrap">
                                <div class="col-10 col-sm-6 col-lg-3">
                                    <div
                                        class=" d-flex flex-column align-items-start my-4 box-features px-2 pt-5 pb-4 m-auto">
                                        <div class="d-flex flex-row w-100 py-3 border-bgradient">
                                            <img src="<?= base_url(); ?>assets/img/features-1.png" alt="">
                                            <h4 class="f-lexend ms-3 mt-3">100% Secure</h4>
                                        </div>
                                        <a class="f-lexend my-auto"
