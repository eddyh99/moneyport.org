    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    <div class="col-12 col-md-8 mb-5 text-center m-auto">
                        <h2 class="title-top-header f-poppins fw-bold">
                            MoneyPort provides clients<br>
                            ''Non-Custodial Wallet''<br>
                            The funds are really yours
                        </h2>
                        <div class="my-3">
                            <p>
                                With a non-custodial wallet, your private keys are completely under your control and
                                which prove that funds are yours.
                            </p>
                        </div>
                    </div>
        ...
        <div class="col-12 my-5 px-md-5">
            <div class="row">
                <div class="col-12 text-center mx-auto">
                    <h2 class="fw-bold f-poppins title-top-header">Fully protection of your privacy “No KYC & No AML’’
                    </h2>
                </div>
                <div class="col-12 col-md-8 mb-5 text-start m-auto">
                    ...
                    <div class="my-3">
                        <p>
                            MoneyPort is part of the TracklessBank circuit and can operate by using several bank
                            licenses under different jurisdictions and provides offshore escrow accounts. In addition
                            MoneyPort is not obliged to perform the Know You Customer (KYC) procedure as clients'
                            wallets are non-custodial wallets.<br>
                            MoneyPort does not carry out Anti-money laundering (AML) compliance policy, as it legally
                            makes use of the AML which, mandatorily by law, is carried out by the banking institution
                            that introduced fiat into the banking circuit.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 d-none d-md-grid m-auto">
        ...
        <div class="col-12 my-5 px-md-5">
            <div class="row">
                <div class="col-12 text-center mx-auto">
                    <h2 class="fw-bold f-poppins title-top-header">Receive funds in 10 FIAT<br>currencies
                    </h2>
                </div>
                <div class="col-12 col-md-8 mb-5 text-start m-auto">
                    ...
                    <div class="my-3">
                        <p>
                            Bank details are available in 10 FIAT currencies, so you can receive money in 10 different
                            currencies. The banking data of the currencies received will be immediately available for
                            free.<br>
                            You can receive funds or top up your own wallet from any bank account even if it is not
                            under your name.
                        </p>
                    </div>
                </div>
        ...
        <div class="col-12 my-5 px-md-5">
            <div class="row">
                <div class="col-12 text-center mx-auto">
                    <h2 class="title-top-header f-poppins fw-bold">Swap, custody and send<br>
                        worldwide in over 50 currencies</h2>
                </div>
                <div class="col-12 col-md-6 mb-5 text-start mx-auto">
                    <h2 class="subtitle-top-header f-poppins">MoneyPort wherever you are</h2>
                    <div class="my-3 content-freedy text-start">
                        <ul class="p-0">
                            <li>Custody and send money in more than 50 currencies.</li>

                            <li>Swap currencies at the real exchange rate without any fee.</li>

                            <li>Keep your currencies safe in your wallet and send money worldwide.</li>

                            <li>Send/withdraw funds by bank transfer to any bank account even if it is not under you
                                name, everywhere in the world</li>
                        </ul>
                    </div>
                    <div class="my-3 text-start">
                        <h3 class="fw-bold text-blue-freedy">Swap and pay instantly everywhere in the world </h3>
                        <p>From your multi-currency wallet you can instantly convert one of your FIAT balances into the
                            currency of the country you are in and carry out all the payments you want, quickly and
                            easily. MoneyPort offers the best exchange rates you can find on the market and the absence
                            of fees.</p>
                    </div>
                </div>
        ...
        <div class="col-12 my-5 px-md-5">
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-5 text-start mx-auto">
                    <h2 class="fw-bold subtitle-top-header">Easy way to swap</h2>
                    <div class="my-3 content-freedy text-start">
                        <ul class="p-0">
                ...
                <div class="col-12 col-md-4 d-none d-md-grid my-auto">
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <div class="px-4">
                                    ...
                                    <p class="text-mute">Convert your balance into the currency that you want to send
                                    </p>
                                </div>
                            </li>
                            <li
                            ...
                            <li
                                ...
                                <div class="px-4">
                                    <div class="event-date bg-line-circle"></div>
                                    <p class="text-mute">DONE! You sent the chosen currency as a national bank transfer
                                    </p>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="col-12 mb-3 text-center">
            <h1>Buy and Sell Crypto from FIAT </h1>
        </div>

        <div class="col-12 text-center">
            <div class="content-freedy">
                <p>
                    MoneyPort offers the possibility to buy and sell cryptocurrencies using FIAT,
                    directly from any FIAT balance of your MoneyPort wallet.<br>
                    MoneyPort also give the possibility to withdraw<br>
                    your funds by converting them INTO ANY FIAT CURRENCY; after conversion you can send your funds to
                    any bank account, even if it is not under your name,<br>
                    thanks to the integrated trade-off platform.<br>
                    <br>
                    <b>MoneyPort, being a trade-off platform, the ‘’Buy’’ and ‘’Sell’’ orders are just ‘’LIMIT’’
                        orders.</b>
                </p>
