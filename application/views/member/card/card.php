                        ...
                        <div class="mt-5 f-poppins">
                            ...
                            <div class="d-flex justify-content-between card-number my-1">
                                ...
                                <div class="d-flex justify-content-end">
                                    <input type="text" id="cardnumcopy" class="text-end mx-3 w-100" value="<?=$detailcard->cardnumber?>" readonly>
                            ...
                            <div class="d-flex justify-content-between my-1 card-cvv">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <input id="text-secret2" type="password" class="text-end mx-3 fw-semibold w-50" value="<?=$detailcard->cvv?>" readonly>
